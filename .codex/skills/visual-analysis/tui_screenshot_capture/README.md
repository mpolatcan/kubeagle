...
> **Location**: `.codex/skills/visual-analysis/tui_screenshot_capture/`
> **Version**: 1.1.0
...
Since this module is located under the `.codex/skills/visual-analysis/` directory, use PYTHONPATH to run it:

```bash
source venv/bin/activate
PYTHONPATH=.codex/skills/visual-analysis python -m tui_screenshot_capture --help
```

Or set up an alias for convenience:
```bash
alias capture-tui='PYTHONPATH=.codex/skills/visual-analysis python -m tui_screenshot_capture'
capture-tui --help
```
...
source venv/bin/activate
export PYTHONPATH=.codex/skills/visual-analysis
...
PYTHONPATH=.codex/skills/visual-analysis python -m tui_screenshot_capture capture optimizer \
    --charts-path ../web-helm-repository \
    --output /tmp/screenshots
