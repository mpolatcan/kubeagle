...
NODE_TABLE_COLUMNS: list[tuple[str, int]] = [
    ...
    ("Node Group", 28),
    ("Pod Usage", 20),
    ("CPU Usage/Alloc (m)", 24),
    ("Mem Usage/Alloc (GiB)", 26),
    ("CPU Req/Alloc (m)", 24),
...
NODE_GROUPS_TABLE_COLUMNS: list[tuple[str, int]] = [
    ("Node Group", 28),
    ("Nodes", 8),
    ("CPU Use % (Avg/Max/P95)", 24),
    ("Mem Use % (Avg/Max/P95)", 24),
...
CLUSTER_TABLE_HEADER_TOOLTIPS: dict[str, dict[str, str]] = {
    ...
    "nodes-table": {
        ...
        "CPU Usage/Alloc (m)": "Real CPU usage over allocatable CPU as percentage and usage/alloc pair in millicores.",
        "Mem Usage/Alloc (GiB)": "Real memory usage over allocatable memory as percentage and usage/alloc pair in GiB.",
    ...
    "node-groups-table": {
        ...
        "CPU Use % (Avg/Max/P95)": "Real CPU usage utilization triplet in Avg/Max/P95 order.",
        "Mem Use % (Avg/Max/P95)": "Real memory usage utilization triplet in Avg/Max/P95 order.",
